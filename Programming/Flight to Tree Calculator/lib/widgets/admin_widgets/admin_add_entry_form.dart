...
class _AdminAddEntryFormState extends State<AdminAddEntryForm> {
  ...
  Widget build(BuildContext context) {
    final crud = Provider.of<AdminCRUDModel>(context);
                  ...
                  RegisterButton(
                    ...
                    function: () {
                      if (checkFields()) {
                        ...
                        admin.calculateAdminTotals(widget.adminEntries, widget.profileEntries, admin.adminOnly);
